...
@NgModule({
  ...
  declarations: [AppComponent, LandingPageComponent,UserListComponent,RegisterComponent,SiteListComponent,LoginComponent, ConfirmesiteComponent, KeywordComponent, UsersComponent, LoginnComponent, RapportComponent],
  imports: [
